...
'mail.markdown.paths','nativephp.version','nativephp.version_code','nativephp.app_id','nativephp.deeplink_scheme',
'nativephp.deeplink_host','nativephp.start_url','nativephp.development_team','nativephp.cleanup_env_keys','nativephp.cleanup_exclude_files',
'nativephp.android.gradle_jdk_path','nativephp.android.android_sdk_path','nativephp.android.emulator_path','nativephp.android.7zip-location','nativephp.android.status_bar_style',
'nativephp.android.build.minify_enabled','nativephp.android.build.shrink_resources','nativephp.android.build.obfuscate','nativephp.android.build.debug_symbols','nativephp.android.build.generate_mapping_files',
'nativephp.android.build.mapping_file_path','nativephp.android.build.keep_line_numbers','nativephp.android.build.keep_source_file','nativephp.android.build.custom_proguard_rules','nativephp.android.build.parallel_builds',
'nativephp.android.build.incremental_builds','nativephp.server.http_port','nativephp.server.ws_port','nativephp.server.service_name','nativephp.server.service_type',
'nativephp.server.public_path','nativephp.server.build_path','nativephp.server.open_browser','nativephp.server.watch_paths','nativephp.server.watch_extensions',
'nativephp.hot_reload.watch_paths','nativephp.hot_reload.exclude_patterns','nativephp.app_store_connect.api_key','nativephp.app_store_connect.api_key_id','nativephp.app_store_connect.api_issuer_id',
'nativephp.app_store_connect.app_name','nativephp.permissions','nativephp.ipad','nativephp.orientation.iphone.portrait','nativephp.orientation.iphone.upside_down',
'nativephp.orientation.iphone.landscape_left','nativephp.orientation.iphone.landscape_right','nativephp.orientation.android.portrait','nativephp.orientation.android.upside_down','nativephp.orientation.android.landscape_left',
'nativephp.orientation.android.landscape_right','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','nativephp-internal.running','nativephp-internal.platform','nativephp-internal.tempdir',
...
'dashboard','expenses.settle','expenses.history','expenses.index','expenses.create',
'expenses.store','expenses.edit','expenses.update','expenses.destroy','shopping-lists.duplicate',
'shopping-lists.index','shopping-lists.create','shopping-lists.store','shopping-lists.show','shopping-lists.update',
'shopping-lists.destroy','shopping-items.store','shopping-items.update','shopping-items.toggle-check','shopping-items.destroy',
