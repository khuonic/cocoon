...
'nativephp.cleanup_exclude_files','nativephp.android.gradle_jdk_path','nativephp.android.android_sdk_path','nativephp.android.emulator_path','nativephp.android.7zip-location',
'nativephp.android.status_bar_style','nativephp.android.build.minify_enabled','nativephp.android.build.shrink_resources','nativephp.android.build.obfuscate','nativephp.android.build.debug_symbols',
'nativephp.android.build.generate_mapping_files','nativephp.android.build.mapping_file_path','nativephp.android.build.keep_line_numbers','nativephp.android.build.keep_source_file','nativephp.android.build.custom_proguard_rules',
'nativephp.android.build.parallel_builds','nativephp.android.build.incremental_builds','nativephp.server.http_port','nativephp.server.ws_port','nativephp.server.service_name',
'nativephp.server.service_type','nativephp.server.public_path','nativephp.server.build_path','nativephp.server.open_browser','nativephp.server.watch_paths',
'nativephp.server.watch_extensions','nativephp.hot_reload.watch_paths','nativephp.hot_reload.exclude_patterns','nativephp.app_store_connect.api_key','nativephp.app_store_connect.api_key_id',
'nativephp.app_store_connect.api_issuer_id','nativephp.app_store_connect.app_name','nativephp.permissions.push_notifications','nativephp.permissions.microphone','nativephp.permissions.camera',
...
'nativephp.orientation.android.portrait','nativephp.orientation.android.upside_down','nativephp.orientation.android.landscape_left','nativephp.orientation.android.landscape_right','queue.default',
...
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','nativephp-internal.running','nativephp-internal.platform',
'nativephp-internal.tempdir','activitylog.enabled','activitylog.delete_records_older_than_days','activitylog.default_log_name','activitylog.default_auth_driver',
...
'nativephp-mobile::components.native-placeholder','nativephp-mobile::components.native-placeholder-with-children','notifications::email','pagination::bootstrap-4','pagination::bootstrap-5',
