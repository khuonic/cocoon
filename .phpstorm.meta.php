...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'cocon.allowed_users.0.name' => 'string',
            'cocon.allowed_users.0.email' => 'string',
            'cocon.allowed_users.1.name' => 'string',
            'cocon.allowed_users.1.email' => 'string',
            'cocon.sync_api_url' => 'string',
            ...
            'filesystems.links.C:\Users\kevin\Herd\cocoon\public\storage' => 'string',
            ...
            'nativephp.version_code' => 'string',
            'nativephp.app_id' => 'string',
            'nativephp.deeplink_scheme' => 'NULL',
            'nativephp.deeplink_host' => 'NULL',
            'nativephp.start_url' => 'string',
            'nativephp.development_team' => 'NULL',
            'nativephp.cleanup_env_keys' => 'array',
            'nativephp.cleanup_exclude_files' => 'array',
            'nativephp.runtime.mode' => 'string',
            'nativephp.runtime.reset_instances' => 'boolean',
            'nativephp.runtime.gc_between_dispatches' => 'boolean',
            'nativephp.android.gradle_jdk_path' => 'NULL',
            'nativephp.android.android_sdk_path' => 'NULL',
            'nativephp.android.emulator_path' => 'NULL',
            'nativephp.android.7zip-location' => 'string',
            'nativephp.android.status_bar_style' => 'string',
            'nativephp.android.build.minify_enabled' => 'boolean',
            'nativephp.android.build.shrink_resources' => 'boolean',
            'nativephp.android.build.obfuscate' => 'boolean',
            'nativephp.android.build.debug_symbols' => 'string',
            'nativephp.android.build.generate_mapping_files' => 'boolean',
            'nativephp.android.build.mapping_file_path' => 'string',
            'nativephp.android.build.keep_line_numbers' => 'boolean',
            'nativephp.android.build.keep_source_file' => 'boolean',
            'nativephp.android.build.custom_proguard_rules' => 'array',
            'nativephp.android.build.parallel_builds' => 'boolean',
            'nativephp.android.build.incremental_builds' => 'boolean',
            'nativephp.server.http_port' => 'integer',
            'nativephp.server.ws_port' => 'integer',
            'nativephp.server.service_name' => 'string',
            'nativephp.server.service_type' => 'string',
            'nativephp.server.public_path' => 'string',
            'nativephp.server.build_path' => 'string',
            'nativephp.server.open_browser' => 'boolean',
            'nativephp.server.watch_paths' => 'array',
            'nativephp.server.watch_extensions' => 'array',
            'nativephp.hot_reload.watch_paths' => 'array',
            'nativephp.hot_reload.exclude_patterns' => 'array',
            'nativephp.app_store_connect.api_key' => 'NULL',
            'nativephp.app_store_connect.api_key_id' => 'NULL',
            'nativephp.app_store_connect.api_issuer_id' => 'NULL',
            'nativephp.app_store_connect.app_name' => 'NULL',
            'nativephp.ipad' => 'boolean',
            'nativephp.orientation.iphone.portrait' => 'boolean',
            'nativephp.orientation.iphone.upside_down' => 'boolean',
            'nativephp.orientation.iphone.landscape_left' => 'boolean',
            'nativephp.orientation.iphone.landscape_right' => 'boolean',
            'nativephp.orientation.android.portrait' => 'boolean',
            'nativephp.orientation.android.upside_down' => 'boolean',
            'nativephp.orientation.android.landscape_left' => 'boolean',
            'nativephp.orientation.android.landscape_right' => 'boolean',
            'nativephp.permissions.push_notifications' => 'boolean',
            'nativephp.permissions.microphone' => 'boolean',
            'nativephp.permissions.camera' => 'boolean',
            ...
            'nativephp-internal.tempdir' => 'NULL',
...
'cache.stores.failover.driver','cache.stores.failover.stores','cache.prefix','cocon.allowed_users.0.name','cocon.allowed_users.0.email',
'cocon.allowed_users.1.name','cocon.allowed_users.1.email','cocon.sync_api_url','database.default','database.connections.sqlite.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\kevin\\Herd\\cocoon\\public\\storage','fortify.guard',
...
'mail.markdown.paths','mail.markdown.extensions','nativephp.version','nativephp.version_code','nativephp.app_id',
'nativephp.deeplink_scheme','nativephp.deeplink_host','nativephp.start_url','nativephp.development_team','nativephp.cleanup_env_keys',
'nativephp.cleanup_exclude_files','nativephp.runtime.mode','nativephp.runtime.reset_instances','nativephp.runtime.gc_between_dispatches','nativephp.android.gradle_jdk_path',
'nativephp.android.android_sdk_path','nativephp.android.emulator_path','nativephp.android.7zip-location','nativephp.android.status_bar_style','nativephp.android.build.minify_enabled',
'nativephp.android.build.shrink_resources','nativephp.android.build.obfuscate','nativephp.android.build.debug_symbols','nativephp.android.build.generate_mapping_files','nativephp.android.build.mapping_file_path',
'nativephp.android.build.keep_line_numbers','nativephp.android.build.keep_source_file','nativephp.android.build.custom_proguard_rules','nativephp.android.build.parallel_builds','nativephp.android.build.incremental_builds',
'nativephp.server.http_port','nativephp.server.ws_port','nativephp.server.service_name','nativephp.server.service_type','nativephp.server.public_path',
'nativephp.server.build_path','nativephp.server.open_browser','nativephp.server.watch_paths','nativephp.server.watch_extensions','nativephp.hot_reload.watch_paths',
'nativephp.hot_reload.exclude_patterns','nativephp.app_store_connect.api_key','nativephp.app_store_connect.api_key_id','nativephp.app_store_connect.api_issuer_id','nativephp.app_store_connect.app_name',
'nativephp.ipad','nativephp.orientation.iphone.portrait','nativephp.orientation.iphone.upside_down','nativephp.orientation.iphone.landscape_left','nativephp.orientation.iphone.landscape_right',
'nativephp.orientation.android.portrait','nativephp.orientation.android.upside_down','nativephp.orientation.android.landscape_left','nativephp.orientation.android.landscape_right','nativephp.permissions.push_notifications',
'nativephp.permissions.microphone','nativephp.permissions.camera','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'session.same_site','session.partitioned','debugbar.enabled','debugbar.collect_jobs','debugbar.except',
...
'debugbar.options.db.backtrace_exclude_paths','debugbar.options.db.timeline','debugbar.options.db.duration_background','debugbar.options.db.explain.enabled','debugbar.options.db.show_query_result',
...
'sanctum.middleware.validate_csrf_token','nativephp-internal.running','nativephp-internal.platform','nativephp-internal.tempdir','activitylog.enabled',
...
'signed','throttle','verified','household',);
        registerArgumentsSet('routes', 
'debugbar.openhandler','debugbar.cache.delete','debugbar.queries.explain','debugbar.clockwork','debugbar.assets',
'boost.browser-logs','login','login.store','logout','verification.notice',
'verification.verify','verification.send','password.confirm','password.confirmation','password.confirm.store',
'sanctum.csrf-cookie','api.app.download','setup','biometric.login','biometric.verify',
'dashboard','native-image.store','expenses.settle','expenses.history','expenses.changelog',
'expenses.index','expenses.create','expenses.store','expenses.edit','expenses.update',
'expenses.destroy','shopping-lists.duplicate','shopping-lists.index','shopping-lists.create','shopping-lists.store',
'shopping-lists.show','shopping-lists.update','shopping-lists.destroy','shopping-items.store','shopping-items.update',
'shopping-items.toggle-check','shopping-items.destroy','recipes.index','recipes.create','recipes.store',
'recipes.show','recipes.edit','recipes.update','recipes.destroy','notes.index',
'notes.store','notes.show','notes.update','notes.toggle-pin','notes.destroy',
'todo-lists.store','todo-lists.show','todo-lists.update','todo-lists.destroy','todos.store',
'todos.reorder','todos.toggle','todos.update','todos.destroy','calendar.index',
'calendar.store','calendar.update','calendar.destroy','sweet-messages.store','birthdays.index',
'birthdays.store','birthdays.update','birthdays.destroy','more',
'profile.edit','profile.update','user-password.edit','user-password.update','storage.local',
...
'laravel-exceptions::minimal','nativephp-mobile::components.native-placeholder','nativephp-mobile::components.native-placeholder-with-children','notifications::email','pagination::bootstrap-3',
...
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.Users.kevin.Herd.cocoon.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','NATIVEPHP_APP_ID','NATIVEPHP_APP_VERSION',
